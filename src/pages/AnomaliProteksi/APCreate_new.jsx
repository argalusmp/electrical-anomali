...
const APCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { error } = await supabase.from("anomali_proteksi").insert([
        {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 rounded-xl shadow-lg p-6 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold">Tambah Anomali Proteksi</h1>
            <p className="text-blue-100 mt-1">Buat laporan anomali baru untuk sistem proteksi</p>
          </div>
        </div>
      </div>
        ...
        <CardBody className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
              <Button
                type="submit"
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2"
                size="lg"
              >
