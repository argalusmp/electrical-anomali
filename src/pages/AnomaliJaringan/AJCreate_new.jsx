...
import { NAMA_BULAN } from "../../utils/ConstWord";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-600 via-emerald-500 to-teal-600 rounded-xl shadow-lg p-6 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold">Tambah Anomali Jaringan</h1>
            <p className="text-green-100 mt-1">Buat laporan anomali baru untuk jaringan transmisi</p>
          </div>
        </div>
      </div>
        ...
        <CardBody className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Input
                    size="lg"
                    label="Masukkan nama penghantar"
                    value={penghantar}
                    onChange={(e) => setPenghantar(e.target.value)}
                ...
                <div>
                  <Typography variant="h6" className="text-gray-700 mb-2">
                    Span/Tower <span className="text-red-500">*</span>
                  </Typography>
                  <Input
                    size="lg"
                    label="Masukkan span/tower"
                    value={spanTower}
                    onChange={(e) => setSpanTower(e.target.value)}
                    className="focus:border-green-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setKategoriAnomali(e.target.value)}
                    className="focus:border-green-500"
                  />
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
              <Button
                type="submit"
                className="bg-gradient-to-r from-green-600 to-teal-600 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2"
                size="lg"
                disabled={loading}
              >
