...
import { TABS, NAMA_BULAN } from "../../utils/ConstWord";
...
const AJList = () => {
  ...
  const handleSave = async (id) => {
    ...
    await supabase.from("anomali_jaringan").update(updateData).eq("id", id);
    setEditingId(null);
    fetchData();
  };
                ...
                <td className="p-4 border-b border-blue-gray-50">
                  {editingId === row.id ? (
                    <Input
                      ...
                      onChange={(e) =>
                        handleChange("penghantar", e.target.value)
                      }
                    />
                  ) : (
                    <Typography
                ...
                <td className="p-4 border-b border-blue-gray-50">
                  {editingId === row.id ? (
                    <Input
                      ...
                      onChange={(e) =>
                        handleChange("span_tower", e.target.value)
                      }
                    />
                  ) : (
                    <Typography
                ...
                <td className="p-4 border-b border-blue-gray-50">
                  {editingId === row.id ? (
                    <Input
                      ...
                      onChange={(e) => handleChange("phasa", e.target.value)}
                    />
                  ) : (
                    <Typography
                      variant="small"
                ...
                <td className="p-4 border-b border-blue-gray-50">
                  {editingId === row.id ? (
                    <Input
                      ...
                      onChange={(e) =>
                        handleChange("kategori_anomali", e.target.value)
                      }
                    />
                  ) : (
                    <Typography
                ...
                <td className="p-4 border-b border-blue-gray-50">
                  {editingId === row.id ? (
                    <Input
                      ...
                      value={editData.penghantar || ""}
                      onChange={(e) =>
                        handleChange("pelaksana", e.target.value)
                      }
                    />
                  ) : (
                    <Typography
